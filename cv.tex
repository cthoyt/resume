...
There are a total of 60 manuscripts (51 peer-reviewed, 7 pre-printed, and 2 in preparation).
...
\vspace{0.3cm}
    ...
    \textit{in preparation for J. Chem. Inf}, 2025
        \item
        (in~preparation) $\dagger$\wikidata{}{\textbf{Causal inference with $Y_0$}}.
    \textit{in preparation for JOSS}, 2025
    \end{enumerate}
    \begin{enumerate}
    \setcounter{enumi}{4}
    \itemsep0.5em
