...
\cventry{2023--}{Senior Scientist}{Northeastern University}{Boston, MA}{USA (remote)}{}
\cventry{2021--23}{Research Fellow}{Harvard Medical School, Laboratory of Systems Pharmacology}{Boston, MA}{USA (remote)}{Biocuration, data standardization, natural language processing, data integration, and automated assembly of knowledge and models}
...
\vspace{0.3cm}
    ...
    \itemsep0.5em
        \item
        $\dagger$\wikidata{Q123462831}{\textbf{Open code, open data, and open infrastructure to promote the longevity of curated scientific resources}}.
    \textit{OSF Preprints}, 2023.  {\scriptsize \href{https://bioregistry.io/doi:10.31219/OSF.IO/VUZT3}{doi:10.31219/osf.io/vuzt3}}
        \item
    ...
    \textit{NAR}, 2023.  {\scriptsize \href{https://bioregistry.io/doi:10.1093/NAR/GKAD1005}{doi:10.1093/nar/gkad1005}}
        \item
        (preprint) \wikidata{Q120719727}{\textbf{An Open-Source Knowledge Graph Ecosystem for the Life Sciences}}.
    \textit{arXiv}, 2023.  {\scriptsize
        \href{https://bioregistry.io/arxiv:2307.05727}{arxiv:2307.05727}}}
        \item
...
\begin{enumerate}
\itemsep0.5em
    \item \textbf{\href{}{Machine-assisted integration of data and knowledge at scale to support biomedical discovery}}. \textit{NIH BISTI Seminar} (December 7, 2023)
...
\itemsep0.5em
    ...
    \item \textbf{\href{https://bit.ly/sorger-lab-biomappings}{Closing the Semantic Gap: Identifying Missing Mappings and Merging Equivalent Concepts to Support Knowledge Graph Assembly}}. \textit{Sorger Lab Meeting} (August 1, 2022)
...
\section{Funding}
    ...
    \item  \textbf{Advancing Data Integration and Discovery in Biomedicine with the Bioregistry}\\
        Chan Zuckerberg Initiative (DTRA), (2023-329850), \$250K overall, 2023-2025 (24 months), Grant: 2023-329850\\
        PI: Benjamin M. Gyori\\
